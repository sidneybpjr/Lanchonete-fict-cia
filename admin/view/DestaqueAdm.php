        ...
        <div class="panel panel-body">
            ...
            <div class="row">
                ...
                <form name="frmCadastrarDestaque" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="dataDestaque">Data de expiração da promoção. (Nesta data, ela será automaticamente excluída do banco de dados. É opcional.)</label>
                ...
                foreach ($listaDestaques as $dest) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 alignCenter" id="dvDesc">
                            <p>Data_expiração: <?= $modifDatas->ExibirData($dest->getDataExpiracao()); ?></p>
